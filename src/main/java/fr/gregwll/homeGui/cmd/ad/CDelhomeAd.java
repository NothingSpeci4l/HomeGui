...
public class CDelhomeAd implements CommandExecutor, TabCompleter {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if (args.length != 1 || !args[0].contains(":")) {
            p.sendMessage(Constents.getPrefix() + "§f§lUsage: §7/delhomeadmin <playerName>:<homeName>");
            return true;
        }
        ...
        p.sendMessage(Constents.getPrefix() + "§fDeleted home §l" + homeName + "§r§f from player §l" + targetName + "§r§f.");
